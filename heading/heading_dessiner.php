...
//ZWIBBLER
//echo '<script type="text/javascript" src="js/js_dessiner.js"></script>';
//echo '<script src="http://zwibbler.com/zwibbler-demo.js"></script>';
//echo '<script src="http://zwibbler.com/component.js" type="text/javascript"></script>';
